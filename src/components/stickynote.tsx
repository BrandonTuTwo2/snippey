    ...
    return <>
        <Card className="bg-yellow-500 m-5 size-96">
            ...
            <CardContent className="w-full h-4/6" >
                <Textarea className="h-60" placeholder={body} disabled />
            </CardContent>
            <CardFooter>
